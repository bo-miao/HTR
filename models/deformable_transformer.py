...
class DeformableTransformer(nn.Module):
    ...
    def forward(self, srcs, tgt, masks, pos_embeds, query_embed=None):
        ...
        if self.two_stage:
            ...
            query_embed = repeat(query_embed, 'o c -> b t o c', b=b, t=t).flatten(0,1)     # [batch_size*time, num_queries_per_frame, c]
        ...
        # init_reference_out (direct pred by query): [batch_size*time, num_queries_per_frame, 2]
...
class DeformableTransformerEncoder(nn.Module):
    ...
    @staticmethod
    # create n_queries for each position, and multiply valid ratio to norm coord !!!!!
